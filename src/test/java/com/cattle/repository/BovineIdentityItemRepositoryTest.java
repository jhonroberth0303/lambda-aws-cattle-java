...
class BovineIdentityItemRepositoryTest {
    ...
    @Test
    void findById_existingId_callsQueryCorrectly() {
        // Arrange
        ...
        // Act - verificamos que llama al query correctamente
        try {
            bovineRepository.findById(bovineId);
        } catch (Exception e) {
            // Puede fallar por el forEach interno
        }
    ...
    void findByFarmIdAndCategory_withMatches_returnsList() {
        ...
        String farmId = "farm-001";
        String category = "cow";
        List<BovineIdentityItem> bovineIdentityItems = createBovineListWithCategory(farmId, category, 5);
